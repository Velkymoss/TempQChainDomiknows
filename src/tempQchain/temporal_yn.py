...
from tempQchain.programs.program_yn import (
    program_declaration_tb_dense_yn,
)
...
def main(args: Any) -> None:
    ...
    logger.info("Starting YN training...")
    ...
    if args.use_mlflow:
        ...
        mlflow.set_experiment("Temporal_YN")
    ...
    program = program_declaration_tb_dense_yn(
        cur_device,
        pmd=args.pmd,
        beta=args.beta,
